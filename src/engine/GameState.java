...
public class GameState {
  ...
  /**
   * Intermediate aggregation variables max combo, elapsed time and total score you get from
   * previous level
   */
  ...
  public final int getHitBullets() {
    return hitBullets;
  }
}
